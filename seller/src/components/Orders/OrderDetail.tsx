...
export function OrderDetail() {
  ...
  const loadOrder = async () => {
    ...
    try {
      ...
      const detail = response?.data || (response as any) || null;
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-white rounded-xl border border-neutral-200">
            ...
            <div className="divide-y divide-neutral-200">
              {(order.itemsSnapshot || order.items || []).map((item, idx) => (
                <div
                  key={item.id || idx}
          ...
          <div className="bg-white rounded-xl border border-neutral-200 p-6">
            ...
            <p className="text-neutral-700">{order.receiver?.name || order.receiverName || "N/A"}</p>
            <p className="text-neutral-700">{order.receiver?.phone || order.receiverPhone || "N/A"}</p>
            <p className="text-neutral-700">{order.receiver?.address || order.receiverAddress || "N/A"}</p>
          </div>
        </div>
